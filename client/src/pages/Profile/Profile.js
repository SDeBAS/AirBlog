    ...
    const handleDelete = async (postId) => {
        ...
        if (isConfirmed) {
            try {
                ...
                const response = await axios.delete(`http://localhost:5000/backend/posts/${postId}`);
    ...
    useEffect(() => {
        ...
        const fetchUserPosts = async () => {
            try {
                ...
                const response = await axios.get(`http://localhost:5000/backend/posts/user/email/${user.email}`);
